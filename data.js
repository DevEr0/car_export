...
window.SITE_DATA = {
  ...
  "content": {
    "hero": {
      "eyebrow": {
        "en": "Guangzhou, China · Worldwide export",
        "zh": "中国广州 · 全球出口"
      },
      "title": {
        "en": "Drive the Legacy\nof ",
      ...
      "lead": {
        "en": "We source, inspect and ship new and used cars from across China — SUVs, MPVs, EVs and luxury sedans — to Ghana, Africa and beyond at honest, competitive prices.",
        "zh": "我们在全中国寻源、验车并发运全新及二手车辆 —— SUV、MPV、电动车与豪华轿车，以诚实公道的价格运往加纳、非洲及世界各地。"
      },
      "tags": [
        {
    ...
    "inventory": {
      ...
      "intro": {
        "en": "A handpicked look at cars we've recently sourced and prepared for export. Ask on WhatsApp for live availability and a landed price.",
        "zh": "精选我们近期寻源并备妥出口的车辆。欢迎在 WhatsApp 询问现货与到岸价。"
      }
    },
    "services": {
      "eyebrow": {
      ...
      "title": {
        "en": "From a Chinese showroom to your port",
        "zh": "从中国展厅到您的港口"
      },
      "intro": {
        "en": "One contact handles the entire chain, so you buy with confidence from anywhere in the world.",
        "zh": "一个联系人负责全部环节，让您在世界任何角落都能放心购车。"
      }
    },
    "why": {
      "eyebrow": {
      ...
      "intro": {
        "en": "A Guangzhou team that treats your money like our own — transparent, fast, and on the ground where the cars are.",
        "zh": "一支把您的钱当自己钱看的广州团队 —— 透明、快速，且就在车源所在地。"
      }
    },
    "brands": {
      "eyebrow": {
      ...
      "title": {
        "en": "From everyday to extraordinary",
        "zh": "从日常到非凡"
      }
    },
    "faq": {
      ...
      "title": {
        "en": "Your questions, perfectly answered",
        "zh": "您的疑问，逐一解答"
      }
    },
    "cta": {
      ...
      "title": {
        "en": "Drive beyond expectations",
        "zh": "超越期待，自在驰骋"
      },
      "intro": {
        "en": "Let our team guide you to the right car at the right price, sourced in China and delivered to your door.",
        "zh": "让我们的团队为您找到合适的车与合适的价格，中国寻源，直送到家。"
      }
    },
    "contact": {
      "eyebrow": {
      ...
      "title": {
        "en": "Import your next car",
        "zh": "进口您的下一台车"
      },
      "intro": {
        "en": "Send the model you want and where it's headed — we usually reply on WhatsApp within the hour.",
        "zh": "把您想要的车型与目的地发给我们 —— 通常一小时内通过 WhatsApp 回复。"
      }
    }
  },
  "categories": [
